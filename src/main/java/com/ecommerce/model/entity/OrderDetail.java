...
@NamedQueries({
        @NamedQuery(name = "OrderDetail.bestSelling", query = "SELECT od.product, SUM(od.quantity) FROM OrderDetail od GROUP by od.product.productId ORDER BY SUM(od.quantity) DESC"),
