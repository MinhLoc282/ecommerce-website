    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 mt-5 mt-md-2 text-center text-md-left">
                ...
                <label>
                    <textarea class="form-control mb-4" rows="5" style="height: 10em!important;">About yourself: (height, weight, ....)</textarea>
                </label>
...
<section class="products text-center">
    <div class="container">
        <h3 class="mb-4"><a href="#" id="reviews">Customer Reviews</a></h3>
